...
public class task1 {
    public static void main(String[] args) {
        ...
        phonBook.put("Sveta", List.of("123", "987"));
        phonBook.put("Elena", List.of("124", "986"));
        phonBook.put("Sasha", List.of("125", "985"));
        phonBook.put("Dima", List.of("126", "984"));
        phonBook.put("Andrey", List.of("127", "983"));
